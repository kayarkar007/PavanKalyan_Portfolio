...
const SuccessAnimation = () => (
  ...
  >
    ...
    >
      ...
      <h4 className="text-2xl font-black dark:text-white text-slate-900">Message Sent!</h4>
      <p className="dark:text-gray-400 text-slate-500 text-sm font-medium mt-1">I'll get back to you within 24 hours.</p>
    </motion.div>
  </motion.div>
);
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-7">
            <Reveal direction="right" delay={0.4}>
              <div className="glass p-10 rounded-[2.5rem] border dark:border-white/8 border-black/10">
                {status === "success" ? (
                  <SuccessAnimation />
                ) : (
                  <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        <label className="text-xs font-bold dark:text-gray-500 text-slate-600 uppercase tracking-widest ml-1">Name *</label>
                        <input
                          type="text"
                          name="name"
                          ...
                          className="w-full dark:bg-white/5 bg-black/[0.05] border dark:border-white/10 border-black/10 rounded-2xl p-4 dark:text-white text-slate-900 placeholder-slate-400 dark:placeholder-gray-400 focus:outline-none focus:border-[#ffc300]/50 transition-colors text-sm"
                        />
                      </div>
                      <div className="space-y-2">
                        <label className="text-xs font-bold dark:text-gray-500 text-slate-600 uppercase tracking-widest ml-1">Email *</label>
                        <input
                          type="email"
                          name="email"
                    ...
                    <div className="space-y-2">
                      <label className="text-xs font-bold dark:text-gray-500 text-slate-600 uppercase tracking-widest ml-1">Subject</label>
                      <input
                        type="text"
                        name="subject"
                    ...
                    <div className="space-y-2">
                      <label className="text-xs font-bold dark:text-gray-500 text-slate-600 uppercase tracking-widest ml-1">Message *</label>
                      <textarea
                        rows="6"
                        name="message"
                        ...
                        value={form.message}
                        onChange={handleChange}
                        className="w-full dark:bg-white/5 bg-black/[0.05] border dark:border-white/10 border-black/10 rounded-2xl p-4 dark:text-white text-slate-900 placeholder-slate-400 dark:placeholder-gray-400 focus:outline-none focus:border-[#ffc300]/50 transition-colors resize-none text-sm"
                      />
                    </div>
