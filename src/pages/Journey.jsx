...
import { workExperience, education, certifications } from "../data/WorkData";
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-8 relative before:absolute before:left-[1.5rem] before:top-0 before:bottom-0 before:w-[2px] before:bg-white/5">
              {workExperience.map((work, idx) => (
                <Reveal key={work.id} direction="left" delay={idx * 0.1}>
              ...
              <div className="space-y-6">
                {education.map((edu, idx) => (
                  <Reveal key={idx} direction="up" delay={0.2 + idx * 0.1}>
                    <div className="glass p-6 rounded-2xl border-white/5 hover:border-white/10">
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 gap-4">
                {certifications.map((cert, idx) => (
                  <Reveal key={idx} direction="right" delay={0.4 + idx * 0.1}>
                    <div className="flex items-center gap-4 p-4 glass rounded-xl border-white/5 hover:bg-white/5 transition-colors">
