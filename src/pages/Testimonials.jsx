...
const Testimonials = () => {
  return (
    <section id="testimonials" className="w-full py-24 px-6 relative overflow-hidden">
          ...
          {testimonials.map((t, idx) => (
            <Reveal key={idx} direction="up" delay={idx * 0.1}>
              <Tilt className="h-full">
                <div className="glass p-8 rounded-[2rem] border dark:border-white/8 border-black/10 relative overflow-hidden group hover:border-[#ffc300]/20 transition-all duration-500 h-full flex flex-col">
                  {/* Shimmer Effect */}
                  ...
                  {/* Text */}
                  <p className="dark:text-gray-300 text-slate-700 text-sm leading-relaxed mt-5 mb-7 relative z-10 italic flex-grow">
                    "{t.text}"
                  </p>

                  {/* Author */}
                  <div className="flex items-center gap-4 pt-4 border-t dark:border-white/8 border-black/10 mt-auto">
                    {/* Avatar */}
