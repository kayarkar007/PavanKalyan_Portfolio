...
const Home = () => {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      // Retain buttons and stats animations for a different "pop"
      gsap.from(".hero-btns", {
        y: 20,
        opacity: 0,
        duration: 0.8,
          ...
          <div className="space-y-4 overflow-hidden">
            ...
            <Reveal direction="up" delay={1.1}>
              <p className="hero-description text-base dark:text-gray-400 text-slate-600 max-w-lg leading-relaxed pt-4">
                I'm <span className="dark:text-white text-slate-900 font-bold underline decoration-[#ffc300]/50 decoration-2 underline-offset-4">PAVAN KALYAN KAYARKAR</span> —{" "}
