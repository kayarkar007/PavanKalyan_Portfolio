...
const About = () => {
  ...
  return (
    <section 
      id="about" 
      className={`w-full min-h-screen flex justify-center items-center py-16 sm:py-20 px-4 ${theme === "dark" ? "bg-black/10 text-white" : "bg-white/80 text-black"}`}
    >
      <div className="w-full max-w-5xl mx-auto flex flex-col justify-center items-center">
        ...
        <div className="space-y-6 text-center max-w-5xl">
          <p className={theme === "dark" ? "text-sm sm:text-base lg:text-lg leading-relaxed text-gray-100" : "text-sm sm:text-base lg:text-lg leading-relaxed text-gray-800"}>
          ...
          <p className="text-lg sm:text-xl lg:text-2xl mt-8 sm:mt-12 text-[#ffc300]">
